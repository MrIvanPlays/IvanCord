...
function savePatches {
    ...
    git format-patch --zero-commit --full-index --no-signature --no-stat -N \
        -o "$basedir/${what_name}-Patches/" upstream/upstream >/dev/null
    cd "$basedir"
...
savePatches "Waterfall/Waterfall-Proxy" "IvanCord-Proxy"
)